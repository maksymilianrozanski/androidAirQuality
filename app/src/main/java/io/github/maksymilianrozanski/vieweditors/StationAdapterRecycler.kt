...
class StationAdapterRecycler(private val context: Context, var list: MutableList<Station>) : RecyclerView.Adapter<StationAdapterRecycler.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            ...
            val intent = Intent(context, SingleStationActivity::class.java)
